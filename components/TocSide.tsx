  ...
  return (
    <>
      {tableOfContents.length ? (
        <ul className="px-1">
          <div className="text-md lg:text-lg font-medium border-b border-gray-100 dark:border-gray-700 pb-1">
            목차
          </div>
          {tableOfContents.map((toc, i) => (
            <li
              ...
              key={i}
              className={`first-of-type:pt-2 py-1 data-[level=two]:pl-3 data-[level=three]:pl-5 text-gray-400 text-xs hover:text-sm lg:text-sm hover:text-gray-800 dark:hover:text-gray-200 transition-all ${
                activeToc === toc.slug
