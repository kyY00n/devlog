---
id: 23
title: Gradle spring boot plugin의 executable packaging
date: 2023-08-01
description: 실행 가능한 jar, war 아카이브를 패키징 하는 플러그인
tags:
    - bootJar
    - Gradle
    - SpringBoot
...
![240827-231429](/posts/23-gradle-exacutable/240827-231429.png)
...
## [OCI](https://github.com/opencontainers/image-spec) 이미지 패키징
