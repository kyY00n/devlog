        ...
        <div className="min-w-[250]">
          ...
          <div className="flex gap-5 items-center mt-4">
            <a
              ...
              className="flex gap-2 items-center hover:scale-110 transition-transform duration-500 hover:text-rose-400 hover:fill-rose-500 dark:fill-white dark:hover:fill-rose-400"
            >
            ...
            <a
              ...
              className="flex gap-2 items-center transition-transform duration-500 hover:scale-110 hover:text-rose-400 hover:fill-rose-500 dark:fill-white dark:hover:fill-rose-400"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
