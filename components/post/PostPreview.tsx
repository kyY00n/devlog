...
const PostPrivew = ({ id, date, title, des, tags }: PostPreviewProps) => {
  return (
    <Link href={`/posts/${id}`} passHref className="w-full my-5">
      ...
      <div className="font-medium transition text-gray-600 dark:text-gray-400 mt-1">
        {des}
      </div>
